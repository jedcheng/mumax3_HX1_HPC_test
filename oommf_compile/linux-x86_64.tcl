...
$config SetValue thread_count 128  ;# Replace '4' with desired thread count.
#
...
$config SetValue fma_type 1 ;# Replace '1' with desired type
#
...
#$config SetValue program_compiler_xp_use_fma 1
#
